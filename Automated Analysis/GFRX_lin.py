...
class GFRX_linCipher(AbstractCipher):
    name = "GFRX_lin"
    ...
    def createSTP(self, stp_filename, parameters):
        ...
        with open(stp_filename, 'w') as stp_file:
            ...
            stpcommands.setupVariables(stp_file, w1, wordsize + 1)
            stpcommands.setupVariables(stp_file, w2, wordsize + 1)
            stpcommands.setupVariables(stp_file, w3, wordsize + 1)
            ...
            # stp_file.write("ASSERT((x10)= 0hex0004);\n")
            # stp_file.write("ASSERT((x20)= 0hex0001);\n")
            # stp_file.write("ASSERT((x30)= 0hex0001);\n")
            # stp_file.write("ASSERT((x40)= 0hex0004);\n")
            #
            # stp_file.write("ASSERT((x11)= 0hex0010);\n")
            # stp_file.write("ASSERT((x21)= 0hex0004);\n")
            # stp_file.write("ASSERT((x31)= 0hex0004);\n")
            # stp_file.write("ASSERT((x41)= 0hex0010);\n")
            #
            # stp_file.write("ASSERT((x12)= 0hex0040);\n")
            # stp_file.write("ASSERT((x22)= 0hex0010);\n")
            # stp_file.write("ASSERT((x32)= 0hex0010);\n")
            # stp_file.write("ASSERT((x42)= 0hex0040);\n")
    ...
    def setupRound(self, stp_file, x1, x2, x3, x4, y1, y2, y3, y4, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19, t20, t21, t22, t23, t24, t25, t26, t27, t28, w1, w2, w3, wordsize):
        command = ""
        command += stpcommands.branch_lin(x2, t1, t2, wordsize)
        command += stpcommands.branch_lin(t2, t3, t4, wordsize)
        command += stpcommands.branch_lin(t4, t5, t6, wordsize)
        ...
        command += stpcommands.and_lin(t7, t8, t9, w1, wordsize)
        command += stpcommands.xor_lin(x1, t9, t11, wordsize)
        command += stpcommands.xor_lin(t10, t11, y3, wordsize)

        command += stpcommands.branch_lin(x3, t12, t13, wordsize)
        command += stpcommands.branch_lin(t13, t14, t15, wordsize)
        command += stpcommands.branch_lin(t15, t16, t17, wordsize)
        ...
        command += stpcommands.and_lin(t18, t19, t20, w2, wordsize)
        command += stpcommands.xor_lin(x4, t20, t22, wordsize)
        command += stpcommands.xor_lin(t21, t22, y2, wordsize)

        command += stpcommands.rrotate(t6, t23, 8, wordsize)
        command += stpcommands.branch_lin(t17, t24, t25, wordsize)
        command += stpcommands.add_lin(t23, t24, t27, w3, wordsize)
        command += stpcommands.lrotate(t25, t26, 3, wordsize)
        command += stpcommands.branch_lin(t27, t28, y1, wordsize)
        command += stpcommands.xor_lin(t28, t26, y4, wordsize)
